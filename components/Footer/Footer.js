...
import LogoRadar from "../Home/OurScale/LogoMotion";
import { useTranslation } from "next-i18next";

const Footer = () => {
  const { t } = useTranslation();

  const recipientEmail = "h.azizdokht@gmail.com";
  ...
  return (
    <footer className="bg-white relative" id="footer">
      <div className="middleElm relative">
        {/* <Logo_network /> */}
        {/* <img
      ...
      <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24 relative z-50">
        ...
        <div className="mt-16 border-t border-gray-100 pt-8 sm:flex sm:items-center sm:justify-between lg:mt-24">
          ...
          <ul className="mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end">
            ...
            <li>
              <a
                href="https://github.com/Hossein-azizdokht"
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:opacity-75"
              >
            ...
            <li>
              <a
                href="https://dribbble.com/HosseinAzizdokht"
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:opacity-75"
              >
